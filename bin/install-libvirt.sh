...
if execute_helm_upgrade helm_command HELM_PASS_THROUGH; then
    echo "Helm upgrade successful. Waiting for Libvirt DaemonSet rollout..."
    wait_for_resource_ready "$SERVICE_NAMESPACE" daemonset 300 libvirt
