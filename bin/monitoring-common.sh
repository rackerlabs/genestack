...
monitoring_apply_secret_from_kubesecrets() {
    # Kept for backward compatibility with legacy kubesecrets.yaml workflows.
    # New deployments should rely on auto-generated secrets instead.
    echo "Warning: kubesecrets.yaml support is deprecated. Secrets are now auto-generated by install scripts."
    return 1
}
