...
set_args=(
    ...
    --set "endpoints.identity.auth.tempest.password=$(kubectl --namespace openstack get secret tempest-admin -o jsonpath='{.data.password}' | base64 -d)"
)
