...
# Service
SERVICE_NAME="blazar-reservation-splitter"
SERVICE_NAMESPACE="openstack"

# Helm
HELM_REPO_NAME="genestack-blazar-reservation-splitter-helm-chart"
HELM_REPO_URL="https://rackerlabs.github.io/genestack-blazar-reservation-splitter-helm-chart"
