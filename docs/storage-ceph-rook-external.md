...
``` shell
./cephadm shell
curl -L -o create-external-cluster-resources.py https://raw.githubusercontent.com/rook/rook/release-1.20/deploy/examples/create-external-cluster-resources.py
...
curl -L -o /etc/genestack/helm-configs/rook-values-external.yaml https://raw.githubusercontent.com/rook/rook/refs/tags/v1.16.5/deploy/charts/rook-ceph-cluster/values-external.yaml
