# Product Matrix for release-2026.2.0

This matrix is generated from the exact git diff between `release-2026.1.0` and `release-2026.2.0`.

## Chart Changes In This Release

| Chart Name | Previous Version | New Version | Change Type |
| :--- | :--- | :--- | :--- |
| **cert-manager** | `v1.19.2` | `v1.19.5` | `Updated` |
| **ironic** | `2024.2.121+13651f45-628a320c` | `2025.1.4+ed289c1cd` | `Updated` |
| **topolvm** | `-` | `16.1.1` | `Added` |
