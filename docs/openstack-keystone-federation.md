...
!!! example "The resultant should have the following files `/etc/genestack/keystone-sp`"
...
kubectl -n openstack create secret generic keystone-shibd-etc \
        ...
        --from-file=/etc/genestack/keystone-sp/shibboleth/console.logger \
        ...
        --from-file=/etc/genestack/keystone-sp/shibboleth/native.logger \
